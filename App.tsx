        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-xs leading-relaxed">
              We are a participant in affiliate programs. We may earn a commission from links to products. Compatibility data is generated by AI and should be verified with manufacturer specifications.
            </p>
          </div>
        </div>
